...
# بخش ۵ — اولین برنامه پایتون شما

تبریک!

اکنون پایتون روی سیستم شما نصب شده و آماده استفاده است.

وقت آن رسیده که اولین برنامه پایتون خود را بنویسید و اجرا کنید.
...
اگر همه‌چیز به‌درستی انجام شده باشد، وارد محیط تعاملی پایتون خواهید شد.

---

## اولین برنامه شما

دستور زیر را دقیقاً مانند نمونه وارد کنید:
...
پایتون بلافاصله خروجی زیر را نمایش می‌دهد:
...
<p align="center">
  <em>شکل ۸ — اجرای اولین برنامه پایتون.</em>
</p>
...
بیایید این دستور را بررسی کنیم.

```python
print("Hello, World!")
```

- `print()` یکی از توابع داخلی پایتون است.
- `"Hello, World!"` یک رشته (String) است.
- تابع `print()` متن داخل رشته را روی صفحه نمایش می‌دهد.

این اولین برنامه پایتون شماست.

---

## خودتان امتحان کنید

حالا متن دلخواه خود را چاپ کنید.
...
می‌توانید متن داخل گیومه را با هر عبارتی که دوست دارید جایگزین کنید.

---

> 💡 **نکته کاربردی**
>
> بهترین راه یادگیری برنامه‌نویسی، تمرین کردن است.
> چند بار متن داخل `print()` را تغییر دهید و نتیجه را مشاهده کنید.

---

## چرا «Hello, World!»؟

عبارت **Hello, World!** سال‌هاست که به‌عنوان اولین برنامه در بسیاری از زبان‌های برنامه‌نویسی استفاده می‌شود.

هدف آن ساده است:

اطمینان از اینکه محیط برنامه‌نویسی به‌درستی کار می‌کند و در عین حال، شما را با ساده‌ترین ساختار یک برنامه آشنا می‌کند.
...
- پایتون را در ویندوز نصب کنید.
- نصب را بررسی کنید.
- وارد محیط تعاملی پایتون شوید.
- اولین برنامه پایتون خود را اجرا کنید.

اکنون یک محیط کامل و آماده برای برنامه‌نویسی با پایتون در اختیار دارید.

در درس بعد، **Visual Studio Code** را نصب می‌کنیم و برنامه‌های خود را در فایل‌های واقعی با پسوند `.py` خواهیم نوشت.
