...
> [!IMPORTANT]
> Try to answer every question **without looking at the previous lessons.**
...
- Don't rush.
- If you're unsure, think about the problem-solving process you've learned.
...
You want to calculate the average of three numbers.
...
| Score | Result |
|--------|--------|
| **9–10** | 🌟 Excellent! You're ready for the Beginner module. |
| **7–8** | ✅ Great job! Review a few topics and continue. |
| **5–6** | 📖 Good start. Review the lessons before moving on. |
| **0–4** | 🔄 Revisit this module and practice more before continuing. |
